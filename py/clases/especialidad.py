...
class especialidad(bd.base_datos):
    def __init__(self):
        self.cod_esp=''
        self.nom_esp=''
        self.est_esp=''
    def agregar(self):
        ...
        sql=f"""select public.especialidad_agregar('{self.nom_esp}')"""
        self.conectar()
    ...
    def modificar(self):
        ...
        sql=f"""select public.especialidad_modificar('{self.nom_esp}','{self.est_esp}',{self.cod_esp})"""
        self.conectar()
        self.cursor.execute(sql) #*Le decimos al cursor que deseamos ejecutar la sentencia sql
        self.conexion.commit() #*Confirmamos la ejecución de la sentencia sql
    ...
    def listar(self):
        ...
        sql=f"""select public.especialidad_listar()"""
        self.conectar()
        self.cursor.execute(sql) #*Le decimos al cursor que deseamos ejecutar la sentencia sql
        self.conexion.commit() #*Confirmamos la ejecución de la sentencia sql
    ...
    def eliminar(self):
        ...
        sql=f"""select public.especialidad_eliminar({self.cod_esp})"""
        self.conectar()
        self.cursor.execute(sql) #*Le decimos al cursor que deseamos ejecutar la sentencia sql
        self.conexion.commit() #*Confirmamos la ejecución de la sentencia sql
        contador=self.cursor.rowcount #*contador de resultados
    ...
    def reanudar(self):
        ...
        sql=f"""select public.especialidad_reanudar({self.cod_esp})"""
        self.conectar()
        self.cursor.execute(sql) #*Le decimos al cursor que deseamos ejecutar la sentencia sql
        self.conexion.commit() #*Confirmamos la ejecución de la sentencia sql
        contador=self.cursor.rowcount #*contador de resultados
